...
| [V](https://vlang.io/) | V | V  Language is Simple, fast, safe, compiled language for developing maintainable software. it can emit (human readable) C with consideration, support, and optimization of GCC and Clang. V can call C code, and calling V code is possible in any language that has C interop. V can translate a C coded program to its own syntax. |
